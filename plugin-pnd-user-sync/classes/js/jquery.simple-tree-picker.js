...
//                        }
            ...
            var buildSubTree = function(obj, html, i) {
                ...
                $(obj).each(function(j) {
                    ...
                    t += '<label>'
                    t += '<input type="checkbox" name="' + inputname + '" value="' + this[code] + '" data-code="' + this[code] + '" data-depth="' + this.depth + '" data-is-last="' + this.is_last + '" data-parent="' + this[parentcode] + '">';
                    t += this[codename] + '</label>';
                    i++;
