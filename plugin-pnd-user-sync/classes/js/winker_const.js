...
WProperties = {
    strHostP : 'dev-daemon.lguplus.co.kr',
    intPortP : 7001,
    strHostB : 'dev-daemon.lguplus.co.kr',
    intPortB : 7001,
    wssFlag  : true
};
...
*/
WAgentStatus = {
    0 : {name: 'Unknown',             text: '알수없음'},
    1 : {name: 'LoggedOut',           text: '로그아웃'},
    2 : {name: 'LoggedIn',            text: '로그인'},
    3 : {name: 'WaitForNextCall',     text: '대기'},
    4 : {name: 'NotReadyForNextCall', text: '이석'},   // AUX
    5 : {name: 'AfterCallWork',       text: '후처리'}, // ACW
    6 : {name: 'CallDialing',         text: '호 발신'},
    7 : {name: 'CallRinging',         text: '호 인입 벨울림'},
    8 : {name: 'CallOnHold',          text: '통화 호 보류'},
    9 : {name: 'CallUnknown',         text: '알 수 없는 유형의 호 통화 중'},
    10: {name: 'CallConsultIn',       text: '2step 호전환을 위한 상담사간 통화 호 수신 통화 중'},
    11: {name: 'CallConsultOut',      text: '2step 호전환을 위한 상담사간 통화 호 발신 통화 중'},
    12: {name: 'CallInternalIn',      text: '상담사간 통화 호 수신 통화 중'},
    13: {name: 'CallInternalOut',     text: '상담사간 통화 호 발신 통화 중'},
    14: {name: 'CallOutbound',        text: 'OB'},
    15: {name: 'CallInbound',         text: 'IB'},
    99: {name: 'EtcGroup',            text: '기타'} // (화면에 표기되는 대기,이석,후처리,OB,IB 5개 상태를 제외한 나머지 상태)
};

/*
    현재 상태 (115) - 사용자 화면 표기 텍스트
*/
/*
WAgentStatusText = {
    3  : '대기',
    ...
    14 : 'OB',
    15 : 'IB',
    99 : '기타' // 화면에 표기되는 대기,이석,후처리,OB,IB 5개 상태를 제외한 나머지 상태
};
*/
...
WAuxStatus = {
    ...
    6: {name: 'Data processing',          text: '자료입력'},
    7: {name: 'Etc',                      text: '기타'}
};

/*
    이석(AUX) 상세 사유 (117) - 사용자 화면 표기 텍스트
*/
/*
WAuxStatusText = {
    1 : '마사지',
