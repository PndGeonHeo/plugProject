...
(function (global, factory) {
  ...
  var EVENT_CUSTOM_LAYOUT_END = 'cLayoutEnd'; /*custom*/
  ...
  Packer.prototype._onWorkerMessage = function (msg) {
    ...
    if (layout && callback) {
      ...
      /*custom*/
      var cGrid = Object.values(GRID_INSTANCES)[0];
      if (!cGrid._isCLayoutFinished) {
        cGrid._emit(EVENT_CUSTOM_LAYOUT_END, null);
        cGrid._isCLayoutFinished = true;
      }
    }
